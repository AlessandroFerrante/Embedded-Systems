/**
 * @file gasStationWithTimers.c
 * @author Alessandro Ferrante (github@alessandroferrante.net)
 * @brief 
* The code implements the control of a service station using an STM32 microcontroller.
* The program manages the fuel dispensing and the user interface through the management functions
* of the interrupts generated by the timer (TIM3) and by the buttons that control the dispensing and the amount,
