/**
 * @file max7219SPIdriver.c
 * @author Alessandro Ferrante
 * @brief Implementation for controlling a MAX7219 LED matrix display via SPI with STM32.
 *
 * This code provides functions to initialize, configure and control
 * a MAX7219-based LED matrix display using an STM32 board
 * and **SPI communication**. It allows you to send data and commands to the display to
 * control the LEDs on the display by manipulating the MAX7219 registers. 
 * It includes functions to initialize the MAX7219, send data and commands, 
 * control individual pixels and draw rectangles.
 * @version 0.1
 * @date 2025-02-28
 * 
...
#define CS(v)   GPIO_write(GPIOB,4,v) // chip select
